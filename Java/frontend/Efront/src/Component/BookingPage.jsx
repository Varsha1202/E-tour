...
const BookingPage = () => {
    ...
    useEffect(() => {
        fetch(`http://localhost:8086/api/subcategory/${subcategoryMaster}/tours/${tourId}/itenary/booking/${tourId}`)
    ...
    const handleAddPassenger = () => {
        ...
        setFormData({ firstName: "", lastName: "", dob: "", mobile: "", email: "", passengerType: "Extra Person", price: "", baseAmount: "", taxAmount: "" });
    };
    ...
    const confirmBooking = () => {
        const totalBaseAmount = passengers.reduce((sum, passenger) => sum + parseFloat(passenger.baseAmount), 0).toFixed(2);
        const totalTaxAmount = passengers.reduce((sum, passenger) => sum + parseFloat(passenger.taxAmount), 0).toFixed(2);
